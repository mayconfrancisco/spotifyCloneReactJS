...
export default function player(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case Types.PAUSE:
      return { ...state, status: Sound.status.PAUSES };
    ...
    case Types.HANDLE_POSITION:
      return { ...state, postitionShown: state.duration * action.payload.percent };

    case Types.SET_POSITION:
      return { ...state, postition: state.duration * action.payload.percent, positionShown: null };
